...
function alternarTema() {
    cuerpoPagina.classList.toggle("oscuro");
}
...
//el foreach es para cada uno de estos elementos si o si vas ahacer una funcion 
//(es decir si apreto algo en uno de esos elementos si o si me votara el mensajes)
...
const UI = {
    ...
    alternarColor: function() {
        ...
        this.cuerpo.style.color = esOscuro ? "black" : "grey";
    },
